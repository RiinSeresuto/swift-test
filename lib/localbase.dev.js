    ...
    })()(
        {
            ...
            7: [
                function (require, module, exports) {
                    ...
                    var _showUserErrors = _interopRequireDefault(
                        require("../../api-utils/showUserErrors")
                    );
                    ...
                    function add(data, keyProvided) {
                        ...
                        if (!this.userErrors.length) {
                            ...
                            return new Promise(function (resolve, reject) {
                                ...
                                return _this.lf[collectionName]
                                    .setItem(key, data)
                                    .then(function () {
                                        resolve(
                                            _success["default"].call(
                                                _this,
                                                'Document added to "'.concat(
                                                    collectionName,
                                                    '" collection:'
                                                ),
                                                {
            ...
            8: [
                function (require, module, exports) {
                    ...
                    var _selectionLevel = _interopRequireDefault(
                        require("../../api-utils/selectionLevel")
                    );
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            _this.deleteDatabase = function () {
                                ...
                                resolve(
                                    _success["default"].call(
                                        _this,
                                        'Database "'.concat(dbName, '" deleted.')
                                    )
                                );
                            }; // delete collection
                                ...
                                _this.deleteNextCollectionFromQueue = function () {
                                    if (_this.deleteCollectionQueue.queue.length) {
                                        var collectionToDelete =
                                            _this.deleteCollectionQueue.queue[0];

                                        _this.deleteCollectionQueue.queue.shift();

                                        _this.lf[collectionToDelete]
                                            .dropInstance({
                                                name: dbName,
                            ...
                            _this.deleteDocument = function () {
                                ...
                                _this.deleteDocumentByCriteria = function () {
                                    ...
                                    _this.lf[collectionName]
                                        .iterate(function (value, key) {
                                            if (
                                                (0, _isSubset["default"])(
                                                    value,
                                                    docSelectionCriteria
                                                )
                                            ) {
                                        ...
                                        .then(function () {
                                            ...
                                            if (keysForDeletion.length > 1) {
                                                _logger["default"].warn.call(
                                                    _this,
                                                    "Multiple documents ("
                                                        .concat(keysForDeletion.length, ") with ")
                                                        .concat(
                                                            JSON.stringify(docSelectionCriteria),
                                                            " found."
                                                        )
                                                );
                                            }
                                        ...
                                        if (!options.keys) {
                                            collection.sort(function (a, b) {
                                                return a[orderByProperty]
                                                    .toString()
                                                    .localeCompare(b[orderByProperty].toString());
                                            });
                                        } else {
                                            collection.sort(function (a, b) {
                                                return a.data[orderByProperty]
                                                    .toString()
                                                    .localeCompare(
                                                        b.data[orderByProperty].toString()
                                                    );
                                            });
                                        }
                                    }
                        ...
                        this.getDocument = function () {
                            ...
                            _this.getDocumentByCriteria = function () {
                                return _this.lf[collectionName]
                                    .iterate(function (value, key) {
                                        if (
                                            (0, _isSubset["default"])(value, docSelectionCriteria)
                                        ) {
                                        ...
                                        if (!collection.length) {
                                            _logger["default"].error.call(
                                                ...
                                                'Could not find Document in "'
                                                    ...
                                                    .concat(JSON.stringify(docSelectionCriteria))
                                            );
                                        } else {
                                            document = collection[0];

                                            _logger["default"].log.call(
                                                _this,
                                ...
                                return _this.lf[collectionName]
                                    ...
                                    ["catch"](function (err) {
                                        _logger["default"].error.call(
                                            _this,
                                            'Could not find Document in "'
                                                .concat(collectionName, '" collection with Key: ')
                                                .concat(JSON.stringify(docSelectionCriteria))
                                        );
                        ...
                        return new Promise(function (resolve, reject) {
                                ...
                                _this.lf[collectionName]
                                    .iterate(function (value, key) {
                                        if (
                                            ...
                                            var newDocument = (0, _updateObject["default"])(
                                                value,
                                                docUpdates
                                            );
                                            docsToUpdate.push({
                                    ...
                                    .then(function () {
                                        ...
                                        if (docsToUpdate.length > 1) {
                                            _logger["default"].warn.call(
                                                _this,
                                                "Multiple documents ("
                                                    .concat(docsToUpdate.length, ") with ")
                                                    .concat(
                                                        JSON.stringify(docSelectionCriteria),
                                                        " found for updating."
                                                    )
                            ...
                            _this.updateDocumentByKey = function () {
                                ...
                                _this.lf[collectionName]
                                    .getItem(docSelectionCriteria)
                                    .then(function (value) {
                                        newDocument = (0, _updateObject["default"])(
                                            value,
                                            docUpdates
                                        );

                                        _this.lf[collectionName].setItem(
                                            docSelectionCriteria,
                                            newDocument
                                        );
                            ...
                            if (!docUpdates) {
                                ...
                                !(
                                    _typeof(docUpdates) == "object" &&
                                    docUpdates instanceof Array == false
                                )
                            ) {
                                _this.userErrors.push(
                ...
                function (require, module, exports) {
                    ...
                    function doc(docSelectionCriteria) {
                        if (!docSelectionCriteria) {
                            ...
                            typeof docSelectionCriteria !== "string" &&
                            _typeof(docSelectionCriteria) !== "object"
                        ) {
                            this.userErrors.push(
                    ...
                    var logger = {
                        ...
                        log: function log(message, secondary) {
                            if ("development" == "development" && this.config.debug) {
                                var style =
                                    logger.baseStyle +
                                    "background-color: ".concat(logger.colors.log);
                        ...
                        error: function error(message, secondary) {
                            if ("development" == "development" && this.config.debug) {
                                var style =
                                    logger.baseStyle +
                                    "background-color: ".concat(logger.colors.error);
                        ...
                        warn: function warn(message, secondary) {
                            if ("development" == "development" && this.config.debug) {
                                var style =
                                    logger.baseStyle +
                                    "background-color: ".concat(logger.colors.warn);
                            ...
                            })(
                                {
                                    ...
                                    2: [
                                        function (_dereq_, module, exports) {
                                            ...
                                            QueueItem.prototype.otherCallRejected = function (
                                                value
                                            ) {
                                        ...
                                        function (_dereq_, module, exports) {
                                            ...
                                            function _checkBlobSupportWithoutCaching(idb) {
                                                return new Promise$1(function (resolve) {
                                                    ...
                                                    var blob = createBlob([""]);
                                                    txn.objectStore(DETECT_BLOB_SUPPORT_STORE).put(
                                                        blob,
                                                        "key"
                                                    );
                                            ...
                                            function _deferReadiness(dbInfo) {
                                                ...
                                                dbContext.deferredOperations.push(
                                                    deferredOperation
                                                );
                                            ...
                                            function stringToBuffer(serializedString) {
                                                ...
                                                if (
                                                    serializedString[
                                                        serializedString.length - 1
                                                    ] === "="
                                                ) {
                                                    bufferLength--;
                                                    if (
                                                        serializedString[
                                                            serializedString.length - 2
                                                        ] === "="
                                                    ) {
                                                        bufferLength--;
                                                    }
                                                ...
                                                if (
                                                    ...
                                                    if (value instanceof ArrayBuffer) {
                                                        ...
                                                        if (valueType === "[object Int8Array]") {
                                                            ...
                                                            valueType === "[object Int32Array]"
                                                        ) {
                                                            marker += TYPE_INT32ARRAY;
                                                        } else if (
                                                            valueType === "[object Uint32Array]"
                                                        ) {
                                                            marker += TYPE_UINT32ARRAY;
                                                        } else if (
                                                            valueType === "[object Float32Array]"
                                                        ) {
                                                            marker += TYPE_FLOAT32ARRAY;
                                                        } else if (
                                                            valueType === "[object Float64Array]"
                                                        ) {
                                                    ...
                                                    fileReader.onload = function () {
                                                        ...
                                                        callback(
                                                            SERIALIZED_MARKER + TYPE_BLOB + str
                                                        );
                                                    };
                                                ...
                                                localForageInstance[libraryMethod] = function () {
                                                    ...
                                                    return localForageInstance
                                                        ...
                                                        .then(function () {
                                                            return localForageInstance[
                                                                libraryMethod
                                                            ].apply(localForageInstance, _args);
                                                        });
                                                };
                                            }
                                            ...
                                            var LocalForage = (function () {
                                                function LocalForage(options) {
                                                    ...
                                                    for (var driverTypeKey in DefaultDrivers) {
                                                        if (
                                                            DefaultDrivers.hasOwnProperty(
                                                                driverTypeKey
                                                            )
                                                        ) {
                                                            var driver =
                                                                DefaultDrivers[driverTypeKey];
                                                ...
                                                LocalForage.prototype.getDriver =
                                                    function getDriver(
                                                        ...
                                                        var getDriverPromise = DefinedDrivers[
                                                            driverName
                                                        ]
                                                            ? Promise$1.resolve(
                                                                  DefinedDrivers[driverName]
                                                ...
                                                LocalForage.prototype.ready = function ready(
                                                    callback
                                                ) {
                                                    var self = this;
                                                ...
                                                LocalForage.prototype.setDriver =
                                                    function setDriver(
                                                        drivers,
                                                        callback,
                                                        errorCallback
